...
export class InitSchema1761220022499 implements MigrationInterface {
    name = 'InitSchema1761220022499'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "entities" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "type" "public"."entities_type_enum" NOT NULL, "name" text NOT NULL, "street" character varying(225), "city" character varying(100), "state" character varying(100), "country" character varying(100), "googlePlaceId" character varying(100), "latitude" double precision, "longitude" double precision, "socials" jsonb, "createdById" uuid, CONSTRAINT "PK_8640855ae82083455cbb806173d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "entities" ADD CONSTRAINT "FK_d39aad63a7bf13d34f9e204351e" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "entities" DROP CONSTRAINT "FK_d39aad63a7bf13d34f9e204351e"`);
