...
export class InitSchema1747757733625 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "rating" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "score" smallint NOT NULL, "comment" text, "tags" text array, "entityId" uuid, "userId" uuid, CONSTRAINT "PK_ecda8ad32645327e4765b43649e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_RATINGS_ENTITY_DATE" ON "rating" ("entityId", "created_at") `);
        await queryRunner.query(`CREATE INDEX "IDX_RATING_ENTITY" ON "rating" ("entityId") `);
        await queryRunner.query(`CREATE TYPE "public"."entities_type_enum" AS ENUM('product', 'person', 'service', 'experience', 'event')`);
